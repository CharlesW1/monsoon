...
# Setup data
sona_balance = lw_api.fetch_dynamic_balance_by_champion_name("Sona")
sona_balance.champion_icon = dd_api.fetch_icon_by_champion_id(37)
seraphine_balance = lw_api.fetch_dynamic_balance_by_champion_name("Seraphine")
seraphine_balance.champion_icon = dd_api.fetch_icon_by_champion_id(147)
janna_balance = lw_api.fetch_dynamic_balance_by_champion_name("Janna")
janna_balance.champion_icon = dd_api.fetch_icon_by_champion_id(40)
soraka_balance = lw_api.fetch_dynamic_balance_by_champion_name("Soraka")
soraka_balance.champion_icon = dd_api.fetch_icon_by_champion_id(16)
nami_balance = lw_api.fetch_dynamic_balance_by_champion_name("Nami")
nami_balance.champion_icon = dd_api.fetch_icon_by_champion_id(267)

akali_balance = lw_api.fetch_dynamic_balance_by_champion_name("Akali")
akali_balance.champion_icon = dd_api.fetch_icon_by_champion_id(84)
qiyana_balance = lw_api.fetch_dynamic_balance_by_champion_name("Qiyana")
qiyana_balance.champion_icon = dd_api.fetch_icon_by_champion_id(246)
neeko_balance = lw_api.fetch_dynamic_balance_by_champion_name("Neeko")
neeko_balance.champion_icon = dd_api.fetch_icon_by_champion_id(76)
lillia_balance = lw_api.fetch_dynamic_balance_by_champion_name("Lillia")
lillia_balance.champion_icon = dd_api.fetch_icon_by_champion_id(876)
lux_balance = lw_api.fetch_dynamic_balance_by_champion_name("Lux")
lux_balance.champion_icon = dd_api.fetch_icon_by_champion_id(99)
ashe_balance = lw_api.fetch_dynamic_balance_by_champion_name("Ashe")
ashe_balance.champion_icon = dd_api.fetch_icon_by_champion_id(22)
gwen_balance = lw_api.fetch_dynamic_balance_by_champion_name("Gwen")
gwen_balance.champion_icon = dd_api.fetch_icon_by_champion_id(887)
zyra_balance = lw_api.fetch_dynamic_balance_by_champion_name("Zyra")
zyra_balance.champion_icon = dd_api.fetch_icon_by_champion_id(143)
xayah_balance = lw_api.fetch_dynamic_balance_by_champion_name("Xayah")
xayah_balance.champion_icon = dd_api.fetch_icon_by_champion_id(498)
ahri_balance = lw_api.fetch_dynamic_balance_by_champion_name("Ahri")
